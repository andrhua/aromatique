...
import com.kekonyan.aromatique.game.tiled.io.xml.XMLWriter;
...
public class TMXMapWriter
{
    ...
    private static void writeTileset(TileSet set, XMLWriter w, String wp)
        ...
        if (tileBitmapFile != null) {
            ...
            Integer trans = set.getTransparentColor();
            if (trans != null) {
    ...
    private static void writeObjectGroup(ObjectGroup o, XMLWriter w, String wp)
        throws IOException
    {
        List<MapObject> itr = o.getObjects();
        for (MapObject mapObject:itr) writeMapObject(mapObject, w, wp);
    }
