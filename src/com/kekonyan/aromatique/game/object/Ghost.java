...
public class Ghost extends HauntingEnemy {
    ...
    public void update(float elapsedTime) {
        ...
        switch (behaviour){
            case HAUNTING:
                ...
                Vec2 velocity=new Vec2(direction.x/direction.length(), direction.y/direction.length()).mul(.4f);
    ...
    public void render(Canvas canvas) {
        ...
        canvas.drawBitmap(Assets.Game.objects[Assets.Game.Object.GHOST.ordinal()], 0, 0, null);
        canvas.restore();
    }
